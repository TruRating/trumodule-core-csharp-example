...
{
    [TestClass]
    public class WhenActivatingWithRegisgrationCode : MsTestsContext<TruModuleStandalone>
    {
        ...
        public void Setup()
        {
            ...
            MockOf<ITruServiceMessageFactory>()
                .Stub(
                    x =>
                        x.AssembleRequestTransaction(Arg<string>.Is.Anything, Arg<string>.Is.Anything,
                            Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<RequestTransaction>.Is.Anything))
                .Return(objToReturn);
